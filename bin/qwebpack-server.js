...
var optimist = require("optimist")
	...
	.boolean("fekit").describe("fekit", "使用fekit的文件加载模式")
	
	.boolean("combine").describe("combine", "合并访问文件")
	
	.string("mock").describe("mock", "使用指定的mock映射文件响应接口请求")

	.boolean("https").describe("https", "启动https模式server")

	.boolean("compress").describe("compress", "启用gzip压缩")
...
if(argv.fekit)
	options.fekit = argv.fekit;

if(argv.combine)
	options.combine = argv.combine;
